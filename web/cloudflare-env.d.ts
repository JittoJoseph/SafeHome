/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 629a0ca8f55a88c13f0e84beb177a10c)
// Runtime types generated with workerd@1.20260714.1 2026-07-18 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* safehome */;
	API: Fetcher /* worker-api */;
}
